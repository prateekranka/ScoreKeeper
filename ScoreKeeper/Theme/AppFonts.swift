...
struct AppFonts {
    ...
    static let hero = Font.system(size: 52, weight: .black, design: .default).width(.condensed)
    ...
    static let scoreDisplay = Font.system(size: 58, weight: .black, design: .default).width(.condensed)
    static let scoreMedium = Font.system(size: 38, weight: .black, design: .default).width(.condensed)
    static let scoreSmall = Font.system(size: 27, weight: .black, design: .default).width(.condensed)
}
